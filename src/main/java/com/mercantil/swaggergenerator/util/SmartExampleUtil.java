 ...
 * =========================================================
 *
 * Motor de generación de ejemplos basado en semántica
 * del nombre.
 *
 * ✔ Soporta tokens (camelCase → palabras)
 * ✔ Usa abbreviations (cta → cuenta)
 * ✔ Genera valores realistas bancarios
 * ✔ Respeta schemaType OpenAPI
 *
 * =========================================================
 */
public class SmartExampleUtil {
    ...
    public static Object generate(
        ...
        boolean numericField =
                "integer".equals(schemaType)
                        || "number".equals(schemaType);

        boolean stringField =
                "string".equals(schemaType);

        boolean booleanField =
                "boolean".equals(schemaType);

        // =====================================================
        // ✅ CONTEXTO CONSISTENTE
        // =====================================================
        String nombre =
                (String) dataContext.computeIfAbsent(
                        "nombre",
                        k -> "Juan");
        ...
        // ✅ MONTO
        // =====================================================
        if (rawLower.contains("mto")
                || tokens.contains("monto")) {
        ...
        // ✅ TIPO IDENTIFICACIÓN
        // =====================================================
        if (lower.contains("tipoidentificacion")
                || lower.contains("tipoid")) {
        ...
        // ✅ INTENTOS
        // =====================================================
        if (lower.contains("intentos")
                && tokens.contains("disponibles")) {
        ...
        // ✅ ACCION
        // =====================================================
        if (tokens.contains("accion")
                && tokens.contains("requer")) {
        ...
        // ✅ APELLIDOS
        // =====================================================
        if (tokens.contains("apell")
                || tokens.contains("apellido")) {
        ...
        // ✅ NUMERO PERSONA
        // =====================================================
        if ((tokens.contains("per")
                || tokens.contains("persona"))

                && (tokens.contains("nro")
                        || tokens.contains("numero"))) {
        ...
        // ✅ BANCO DESTINO
        // =====================================================
        if ((tokens.contains("banco")
                && tokens.contains("dest"))

                || lower.contains("bancodest")
        ...
        // ✅ APLICACION
        // =====================================================
        if (lower.equals("aplic")
                || tokens.contains("aplicacion")) {
        ...
        // ✅ CODIGO GRUPO
        // =====================================================
        if (lower.contains("codgrupo")
                || (tokens.contains("codigo")
                        && tokens.contains("grupo"))) {
        ...
        // ✅ CODIGO MONEDA
        // =====================================================
        if ((tokens.contains("cod")
                && tokens.contains("moneda"))
                || lower.equals("codmoneda")) {
